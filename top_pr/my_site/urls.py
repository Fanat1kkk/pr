...
urlpatterns = [
    ...
    path('uslugi/<slug:social>/<slug:category>/', view=views.services_filter, name='filter-services'),
    ...
    # path('services/<slug:social>/<slug:tariff>/', view=views.service_tariff, name='service_tariff'),
    path('services/<slug:social>/<slug:category>/<slug:tariff>/', view=views.service_tariff, name='service_tariff'),
    path('services/<slug:social>/<slug:category>/', view=views.social_cat, name='social_cat'),
    path('services/<slug:social>/', view=views.social, name='social'),
]