        ...
        card.innerHTML = `
            <div class="flex flex-col items-center">
                ...
                <div class="flex gap-4">
                    ...
                    <button onclick="openModal(event)" data-info="${service.text_info}" data-speedDay="${service.speed_day}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 py-2 px-4 rounded-lg transition duration-300">Подробнее</button>
                </div>
            </div>
        `;
